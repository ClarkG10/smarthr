...
<body>
    ...
    <main>
        <section>
            <div class="manage">
                <div class="wrap">
                    <div class="label">
                        <h4>ALL ADMIN ACCOUNT</h4>
                        <button onclick="addAdminModal()">ADD ACCOUNT</button>
                    </div>
                    <?php
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="acc-buttons">
                                                    <button style="background-color:blue" onclick="showUpdateModal(<?php echo htmlspecialchars($account['admin_id']) ?>)">UPDATE</button>
                                                    <form action="handlers/account/delete.account.php" method="POST">
                                                        <input type="hidden" name="delete_admin" value="<?php echo htmlspecialchars($account['admin_id']) ?>">
                                                        <button style="background-color:red" type="submit" name="deleteAdminBtn">DELETE</button>
                                                    </form>
                                                </div>
                                            </td>
                                        </tr>

                                        <div class="update-account" id="updateAdmin<?php echo htmlspecialchars($account['admin_id']) ?>">
                                            <div class="update-content">
                                                <div class="update-header">
                                                    <h4>UPDATE ADMIN INFORMATION</h4>
                                                </div>
                                                <div class="update-body">
                                                    <form action="handlers/account/update.account.php" method="POST">
                                                        <input type="hidden" name="admin_id" value="<?php echo htmlspecialchars($account['admin_id']); ?>">
                                                        ...
                                                        <div class="update-input">
                                                            <p>Update Password</p>
                                                            <input type="password" name="update_password" value="">
                                                        </div>
                                                        <div class="update-input-btn">
                                                            <input type="submit" name="submitUpdateBtn" value="UPDATE" style="background-color:blue">
                                                            <button style="background-color:red" type="button" onclick="closeUpdateModal(<?php echo htmlspecialchars($account['admin_id']); ?>)">CANCEL</button>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
                    ...
                    <!-- Add Account Modal -->
                    <div class="add-account" id="addAdmin">
                        <div class="update-content">
                            <div class="update-header">
                                <h4>CREATE ADMIN INFORMATION</h4>
                            </div>
                            <div class="update-body custom-padding">
                                <form action="handlers/account/add.account.php" method="POST" class="addFormAdmin">
                                    <div class="update-row">
                                        <div class="update-input custom-padding">
                                            <p>Firstname</p>
                                    ...
                                    <div class="update-row custom-padding">
                                        <div class="update-input">
                                            <p>Lastname</p>
                                    ...
                                    <div class="update-row custom-padding">
                                        <div class="update-input">
                                            <p>Gender</p>
                                            <select name="gender" style="font-size: 12px; padding: 5px">
                                    ...
                                    <div class="update-input-btn custom-padding">
                                        <input type="submit" name="submitAddAdmin" value="CREATE" style="background-color:blue">
                                        <button style="background-color:red" type="button" onclick="closeAddModal()">CANCEL</button>
                                    </div>
                                </form>
                            </div>
                        </div>
    ...
    <script>
        function addAdminModal() {
            document.getElementById('addAdmin').style.display = 'flex';
        }
        ...
        function showUpdateModal(adminId) {
            document.getElementById('updateAdmin' + adminId).style.display = 'flex';
        }

        function closeUpdateModal(adminId) {
            document.getElementById('updateAdmin' + adminId).style.display = 'none';
        }
    </script>
</body>
